<table class="nextgame" border="0" width="155">
  <tr>
    <td>
      <table width="100%">
        ...
        <tr>
          <td align="center"><!--imgHomeBig--><br /><!--homeName--><br />-<br /><!--guestName--><br /><!--imgGuestBig-->
          </td>
        </tr>
        <tr>
